...
const movies: MovieSeed[] = [
  ...
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w780/cfT29Im5VDvjE0RpyKOSdCKZal7.jpg',
  },
  {
    title: 'The Godfather',
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/3bhkrj58Vtu7enYsRolD1fZdja1.jpg',
  },
  {
    title: 'Fight Club',
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/jSziioSwPVrOy9Yow3XhWIBDjq1.jpg',
  },
  {
    title: 'Pulp Fiction',
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/vQWk5YBFWF4bZaofAbv0tShwBvQ.jpg',
  },
  {
    title: 'Forrest Gump',
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/Cw4hIUIAmSYfK9QfaUW5igp9La.jpg',
  },
  {
    title: 'The Matrix',
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w780/tlm8UkiQsitc8rSuIAscQDCnP8d.jpg',
  },
  {
    title: 'Interstellar',
  ...
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/7fn624j5lj3xTme2SgiLCeuedmO.jpg',
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/9cqNxx0GxF0bflZmeSMuL5tnGzr.jpg',
  },
  {
  ...
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/7IiTTgloJzvGI1TAYymCfbfl3vT.jpg',
  },
  {
    title: 'Joker',
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/udDclJoHjfjb8Ekgsd4FDteOkCU.jpg',
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/vZloFAK7NmvMGKE7VkF5UHaz0I.jpg',
  },
  {
    title: 'Dune',
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w780/qVgZu5BTx6pu4owCvVOm4zjTfOi.jpg',
  },
  {
    ...
    posterUrl: 'https://image.tmdb.org/t/p/w500/jFC4LS5qTAT3PinzdEzINfu1CV9.jpg',
    backdropUrl: 'https://image.tmdb.org/t/p/w500/jFC4LS5qTAT3PinzdEzINfu1CV9.jpg',
  },
  {
    title: 'Inside Out 2',
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/vpnVM9B6NMmQpWeZvzLvDESb2QY.jpg',
  },
]

// ─── Series con episodios ─────────────────────────────────────────
const seriesData: (MovieSeed & { episodes: EpisodeSeed[] })[] = [
  {
    title: 'Breaking Bad',
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/3xnWaLQjelJDDF7LT1WBo6f4BRe.jpg',
    episodes: [
  ...
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/1XS1oqL89opfnbLl8WnZY1O1uJx.jpg',
    episodes: [
      ...
      { seasonNumber: 1, episodeNumber: 3, title: 'Lord Snow', description: 'Jon Snow comienza su entrenamiento en el Muro. Daenerys se adapta a su nuevo papel como esposa del Khal Drogo.', duration: '58m' },
  ...
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/xppeysfvDKVx775MFuH8Z9BlpMk.jpg',
    episodes: [
  ...
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/uOOtwVbSr4QDjAGIifLDwpb2Pdl.jpg',
    episodes: [
  ...
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/in1R2dDc421JxsoRWaIIAqVI2KE.jpg',
    episodes: [
  ...
  },
  {
    ...
    backdropUrl: 'https://image.tmdb.org/t/p/w500/dmo6TYuuJgaYinXBPjrgG9mB5od.jpg',
    episodes: [
...
export async function seed() {
  ...
  for (const m of movies) {
    await db.movie.create({
      data: {
        ...
        coverImage: m.posterUrl,
        backdropImage: m.backdropUrl,
        year: m.year,
        rating: m.rating,
        duration: m.duration,
        genre: m.genre,
  ...
  console.log(`✅ Seeded ${movies.length} películas`)
  ...
  for (const s of seriesData) {
    await db.movie.create({
      data: {
        ...
        coverImage: s.posterUrl,
        backdropImage: s.backdropUrl,
        year: s.year,
        rating: s.rating,
        duration: s.duration,
        genre: s.genre,
  ...
  console.log(`\n🎉 Seed complete!`)
  console.log(`   📊 ${totalMovies} títulos (${movies.length} películas, ${seriesData.length} series)`)
  console.log(`   🎞️  ${totalEps} episodios`)
  console.log(`   🖼️  Posters reales desde CDN público`)
  console.log(`   🔑 Sin API key, sin registro, sin dependencias externas`)
}